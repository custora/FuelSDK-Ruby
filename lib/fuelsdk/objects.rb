        ...
        def post
          if self.respond_to?('folder_property') && !self.folder_id.nil?
            ...
            if !client.package_folders.has_key?(self.folder_media_type) then
              ...
              if client.parent_folders.nil? then
              ...
              newFolder.properties = {"Name" => client.package_name, "Description" => client.package_name, "ContentType"=> self.folder_media_type, "IsEditable"=>"true", "ParentFolder" => {"ID" => client.parent_folders[self.folder_media_type]}}
            ...
            if properties.class == Array
              properties[0][self.folder_property] = client.package_folders[self.folder_media_type]
            else
